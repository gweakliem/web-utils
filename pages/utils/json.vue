  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="space-y-4">
      <div class="relative">
        ...
        <textarea v-model="jsonInput" @scroll="syncScroll" @input="handleInput"
      ...
      <!-- Error message -->
      <div v-if="hasError" class="p-3 bg-red-100 border border-red-300 rounded-lg text-red-700 text-sm">
        {{ errorMessage }} (Line: {{ errorLocation.line }}, Column: {{ errorLocation.column }})
      </div>

      <!-- Success message -->
      <div v-if="showSuccess" class="p-3 bg-green-100 border border-green-300 rounded-lg text-green-700 text-sm">
        JSON is valid!
      </div>
    </div>
  </div>
